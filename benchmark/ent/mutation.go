...
func (m *UserMutation) SetPhoneNum(s string) {
	m.phone_num = &s
}

// PhoneNum returns the value of the "phone_num" field in the mutation.
func (m *UserMutation) PhoneNum() (r string, exists bool) {
	v := m.phone_num
	if v == nil {
		return
	}
...
// OldPhoneNum returns the old "phone_num" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldPhoneNum(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) ResetPhoneNum() {
	m.phone_num = nil
}
...
func (m *UserMutation) SetLoginCount(i int32) {
	m.login_count = &i
	m.addlogin_count = nil
}

// LoginCount returns the value of the "login_count" field in the mutation.
func (m *UserMutation) LoginCount() (r int32, exists bool) {
	v := m.login_count
	if v == nil {
		return
	}
...
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldLoginCount(ctx context.Context) (v int32, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) AddLoginCount(i int32) {
...
func (m *UserMutation) AddedLoginCount() (r int32, exists bool) {
	v := m.addlogin_count
	if v == nil {
		return
	}
...
func (m *UserMutation) Fields() []string {
	...
	if m.phone_num != nil {
		fields = append(fields, user.FieldPhoneNum)
	}
	if m.password != nil {
