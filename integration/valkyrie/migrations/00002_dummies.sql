...
INSERT INTO `new_Comment` (`id`, `textify`, `postId`, `authorId`) SELECT `id`, `text`, `postId`, `authorId` FROM `Comment`;
DROP TABLE `Comment`;
...
INSERT INTO `new_Comment` (`id`, `text`, `postId`, `authorId`) SELECT `id`, `textify`, `postId`, `authorId` FROM `Comment`;
DROP TABLE `Comment`;
ALTER TABLE `new_Comment` RENAME TO `Comment`;
PRAGMA foreign_keys = on;
