...
// AllFieldsSoFarCreate contains model input fields for AllFieldsSoFar creation operations.
//
...
var fullAllFieldsSoFarSelectVal = &AllFieldsSoFarSelect{
	Id:              true,
	StringReq:       true,
	StringOpt:       true,
	StringDefault:   true,
...
func fullAllFieldsSoFarSelect() *AllFieldsSoFarSelect {
	return fullAllFieldsSoFarSelectVal
}
...
// AllFieldsSoFarCreateArgs is the input argument passed to AllFieldsSoFar Create extension hooks.
//
// Fields for AllFieldsSoFar:
//
//	id              int32              default: autoincrement()
...
// AllFieldsSoFarCreateManyArgs is the input argument passed to AllFieldsSoFar CreateMany extension hooks.
//
// Fields for AllFieldsSoFar:
//
//	id              int32              default: autoincrement()
...
// AllFieldsSoFarDeleteManyArgs is the input argument passed to AllFieldsSoFar DeleteMany extension hooks.
type AllFieldsSoFarDeleteManyArgs struct {
	// Where contains all query filter predicates.
	Where []PredicateOf[AllFieldsSoFar]
}

func (a *AllFieldsSoFarDeleteManyArgs) SetWhere(preds ...PredicateOf[AllFieldsSoFar]) *AllFieldsSoFarDeleteManyArgs {
	a.Where = preds
	return a
}
...
func (d *AllFieldsSoFarDelegate) executeCreateMany(ctx context.Context, records []RecordInput, conflictTarget UniqueConstraintTarget, conflictAction *ConflictAction) (int64, error) {
	...
	args := &AllFieldsSoFarCreateManyArgs{
		Data:           inputs,
		ConflictTarget: conflictTarget,
		ConflictAction: conflictAction,
	}

	curr := func(c context.Context, a *AllFieldsSoFarCreateManyArgs) (int64, error) {
...
func (cb *AllFieldsSoFarConflictBuilder[B]) Update(fn func(u *AllFieldsSoFarUpsert)) *B {
	cb.setAction(*AllFieldsSoFarConflictUpdate(fn), cb.conflictTarget)
	return cb.builder
}

// AllFieldsSoFarConflictUpdate creates a custom ConflictAction for AllFieldsSoFar upsert conflicts.
func AllFieldsSoFarConflictUpdate(fn func(u *AllFieldsSoFarUpsert)) *ConflictAction {
...
func (d *AllFieldsSoFarDelegate) executeDeleteMany(ctx context.Context, preds []PredicateOf[AllFieldsSoFar]) (int64, error) {
	...
	args := &AllFieldsSoFarDeleteManyArgs{
		Where: preds,
	}

	curr := func(c context.Context, a *AllFieldsSoFarDeleteManyArgs) (int64, error) {
...
func (d *AllFieldsSoFarDelegate) executeDelete(ctx context.Context, where UniquePredicate[AllFieldsSoFar], additional []PredicateOf[AllFieldsSoFar], selects *AllFieldsSoFarSelect, omits *AllFieldsSoFarOmit) (*AllFieldsSoFar, error) {
	...
	curr := func(c context.Context, a *AllFieldsSoFarDeleteArgs) (*AllFieldsSoFar, error) {
