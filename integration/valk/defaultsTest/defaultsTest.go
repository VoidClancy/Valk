...
func Record(assignments ...valk.FieldAssignmentOf[valk.DefaultsTest]) valk.RecordInput {
...
type CreateHook = func(context.Context, *CreateArgs, CreateQuery) (*valk.DefaultsTest, error)
...
func ConflictUpdate(fn func(u *valk.DefaultsTestUpsert)) *valk.ConflictAction {
	return valk.DefaultsTestConflictUpdate(fn)
}
